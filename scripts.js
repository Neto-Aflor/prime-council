...
function initSmoothScroll() {
  document.querySelectorAll('a[href^="#"]').forEach(function (anchor) {
    anchor.addEventListener('click', function (e) {
      ...
      if (!target) return;
      e.preventDefault();
      var headerOffset = 68; /* altura do site-header fixo + margem */
...
/* ============================================================
   4. HERO — animação de entrada suave nos elementos principais
   ============================================================ */
function initHeroAnimations() {
  var heroElements = document.querySelectorAll(
    '.hero-h1, .hero-consequence, .hero-sub, .hero-invest, .hero-ctas, .hero-testdrive'
  );
  ...
  heroElements.forEach(function (el, index) {
    ...
    /* Pequeno timeout para garantir que a transição seja visível */
    setTimeout(function () {
      el.style.opacity = '';
      el.style.transform = '';
    }, 60);
...
// initCountdown('2026-06-12T09:00:00-03:00');
*/
